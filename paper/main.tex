...
\begin{abstract}
    % Statement
    The merger timescales of isolated low-mass pairs ($\rm 10^8<M_*<5\times10^9\,\Msun$) on cosmologically motivated orbits have not been studied in detail, though isolated high-mass pairs ($\rm 5\times10^9<M_*<10^{11}\,\Msun$) have been studied extensively.
    ...
    Alternatively, static physical separation selections applied equivalently to all galaxy pairs at all redshifts leads a difference in merger rates of up to $\sim1\Gyr$ between low- and high-mass pairs, particularly for $\rsep<150\kpc$. 
    % Importance
